 ...
 * Android 版公開先: https://lagado.jp/fragments/privacy-android.php
 ...
 */
function fragments_android_save_inquiry(string $subject, string $body): bool
{
    $dir = __DIR__ . "/_inbox";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($honeypot !== "") {
        ...
        $subject = "【Literary Fragments Android】お問い合わせ";
        if ($topic !== "") {
            $subject .= "（{$topic}）";
        }
        $body = "Literary Fragments（Android）のサポートページからお問い合わせがありました。\n\n";
        $body .= "【お名前】\n{$name_h}\n\n";
        $body .= "【返信用メール】\n{$email_h}\n\n";
        if ($topic !== "") {
            $body .= "【種別】\n{$topic_h}\n\n";
        ...
        if ($device !== "") {
            $body .= "【端末・Android・アプリ版】\n{$device_h}\n\n";
        }
        $body .= "【内容】\n{$message_h}\n";

        // 迷惑メール行きでも控えは残す
        $logged = fragments_android_save_inquiry($subject, $body);
...
<html lang="ja">
    <head>
        ...
        <title>プライバシーポリシー・サポート（Android） / Privacy &amp; Support (Android) - Literary Fragments</title>
        <style>
            :root {
                --bg-color: #f5f1ea;
                --card-bg: #ffffff;
    ...
    <body>
        <div class="container">
            <div class="header">
                ...
                <p>Literary Fragments（Android） / Lagado Research Institute</p>
            </div>
            ...
            <nav class="nav-jump" aria-label="ページ内リンク">
                ...
                <a href="privacy.php">iOS / 共通ポリシー</a>
            </nav>
            ...
            <div class="card" id="support">
                ...
                <form action="#support" method="POST" class="contact-form">
                    ...
                    <div class="form-group">
                        ...
                        <span class="hint">例: SH-03K / Android 10 / Fragments 1.0</span>
                        <input type="text" id="device" name="device" maxlength="200" placeholder="SH-03K / Android 10 / 1.0">
                    </div>
                    <div class="form-group">
                ...
                <h2>購入・チケットについて</h2>
                <p>AI 解説用チケットのアプリ内課金は Google Play 経由です。領収書・請求は <a href="https://support.google.com/googleplay/answer/2479637" rel="noopener">Google Play ヘルプ</a> もご利用ください。</p>
            </div>

            <div class="card" id="privacy-ja">
                <span class="lang-label">日本語 · プライバシー（Android）</span>
                <p>「Literary Fragments」Android版（表示名 Fragments、以下「本アプリ」）は、ユーザーの皆様のプライバシーを尊重し、個人情報の保護に努めています。本アプリのご利用にあたり、情報の取り扱いについて以下のように定めます。iOS版の方針は <a href="privacy.php">こちら</a> です。</p>
                ...
                <ul>
                    ...
                    <li><strong>Google Play:</strong> チケット購入に必要な決済通信</li>
                    <li><strong>書籍検索（任意）:</strong> ユーザー操作により Google 等の検索を開く場合があります</li>
                </ul>

                <h2>5. 課金および決済情報の取り扱いについて</h2>
                <p>本アプリは AI 解説用の消耗型チケット（アプリ内課金）を提供しています。決済処理はすべて Google LLC（Google Play）を通じて安全に行われ、開発元（Lagado Research Institute / ラガード研究所）がクレジットカード番号等の決済情報に直接アクセスしたり保持したりすることはありません。有料チケット残数および購入トークン（purchaseToken）台帳は端末内に保存されます。Google Play 側の決済・領収に関する取り扱いは、Google のプライバシーポリシーに従います。</p>
            ...
            <div class="card" id="privacy-en">
                <span class="lang-label">English · Privacy (Android)</span>
                <p>"Literary Fragments" for Android (display name Fragments; the "App") respects your privacy. This policy explains how information is handled. The iOS policy is <a href="privacy.php">here</a>.</p>
                ...
                <ul>
                    ...
                    <li><strong>Google Play:</strong> in-app ticket purchases</li>
                    <li><strong>Book search (optional):</strong> opening Google or similar when you choose to search</li>
                </ul>

                <h2>5. In-App Purchases</h2>
                <p>The App offers consumable tickets for AI explanations. Payments are processed securely by Google LLC (Google Play). Lagado Research Institute never accesses or stores your payment card details. Paid ticket balances and purchase tokens are kept on your device. Google Play's handling of payments and receipts is governed by Google's privacy policy.</p>
